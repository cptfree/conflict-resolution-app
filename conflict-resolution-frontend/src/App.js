...
function App() {
              ...
              {showError && (
                <div className="mb-4 p-3 bg-red-50 text-red-700 rounded-lg flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      {mode === 'voice'
                        ? "Try switching to text mode if voice isn't working properly."
                        : "If you're experiencing issues, try refreshing the page or coming back later."}
                    </p>
                  </div>
                </div>
              )}
  ...
  className={`p-5 sm:p-4 rounded-full ${
    isRecording ? 'bg-red-500' : 'bg-blue-500'
  } text-white hover:opacity-90 transition-all touch-manipulation`}
